...
2. **ID is auto-generated by the CLI** (format: `SPEC-YYYYMMDD-HHMMSSMMM`). Do NOT include an ID in the markdown — the CLI response contains the generated ID. If create fails → CLI returns specific field errors, fix the markdown and retry.
